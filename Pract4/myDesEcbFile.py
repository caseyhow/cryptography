...
cipher = DES.new(key, DES.MODE_CBC)  # ====== Write your code here ========
while True:
    ...
    # Encrypt this inputblock and write to the output file
    
    
    cipherbytes = cipher.encrypt(pad(inputblock,BLOCK_SIZE))  # ====== Write your code here ========
