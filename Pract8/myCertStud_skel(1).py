...
# insert your codes to load in the certificate file to 'cert'
...
print("Signature Algorithm: {0}".format(signature_algo_oid._name))  #updated due to change in Cyrptography API change
